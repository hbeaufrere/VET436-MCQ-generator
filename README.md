...
An AI-powered multiple choice question generator for veterinary students. Place your lecture PDFs, PowerPoint slides, or text notes in the `course_materials/` folder and students can generate practice exam questions on-the-fly using Claude.

## Features

- **Auto-loaded materials** — drop files into `course_materials/` and they're imported on startup
- **AI-generated MCQs** — Claude analyzes all course materials and creates exam-style questions
